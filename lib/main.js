...
var LoadMore = function () {
  ...
  LoadMore.prototype.processResults = function processResults(data) {
    ...
    data.elements.forEach(function (el) {
      var result = '<div class="column is-10 text-block">' + '<div class="number-circle has-text-centered">' + count++ + ' </div>' + '<h3 class="is-size-4 orange-text bolder">' + el.title + '</h3><p>' + el.content + '</p></div>';
      results += result;
    });
    var obj = $(results);
  ...
  $('.is-slick-carousel').slick({
    responsive: [{
      ...
      settings: {
        ...
        centerPadding: '40px',
        slidesToShow: 3,
        prevArrow: "<span class='slick-arrow-invisible left'>&nbsp;</span>",
        nextArrow: "<span class='slick-arrow-invisible right'>&nbsp;</span>"
      }
    }, {
      breakpoint: 771,
      settings: {
